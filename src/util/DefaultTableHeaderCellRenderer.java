/**
 * Fonte: https://tips4java.wordpress.com/2009/02/27/default-table-header-cell-renderer/
 */
package util;
...
public class DefaultTableHeaderCellRenderer extends DefaultTableCellRenderer {
  ...
  public DefaultTableHeaderCellRenderer() {
    ...
    setHorizontalTextPosition(LEFT); //Edited
  ...
  public Component getTableCellRendererComponent(JTable table, Object value,
    ...
    if (tableHeader != null) {
      ...
      setBackground(tableHeader.getBackground()); //Edited, addicional line
    }
    
    setIcon(getIcon(table, column));
    setBorder((Border) UIManager.put("TitledBorder.border", new LineBorder(new Color(200,200,200), 1))); //Edited
    return this;
  }
